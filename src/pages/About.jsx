      ...
      <Container>
        ...
        <section className='mb-5'>
          <Row className='gy-4 gy-sm-5'>
            <Col md={9}>
              <h3>Заголовок</h3>
              <p>Цифровая платформа для занимающихся профессиональным, полупрофессиональным и любительским спортом, а также для проведения досуговых мероприятий с автоматизированной системой и единым реестром участников и спортсменов.
              </p>
            </Col>
