...
const ParticipantInCommand = (props) => {
    const {firstName, lastName, birthDate:birthDateFromServer, city, gender, weight, image, approved} = props
...
export default ParticipantInCommand;